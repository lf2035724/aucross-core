...
public class BeanInvokingJobDetailFactoryBean implements FactoryBean<JobDetail>, BeanNameAware, InitializingBean, ApplicationContextAware
{
	/**
	...
	public void afterPropertiesSet() throws Exception
	{
		try
		{
			...
			JobBuilder jobBuilder = JobBuilder.newJob(
						concurrent?BeanInvokingJob.class:StatefulBeanInvokingJob.class
			...
			logger.info("创建任务[JobDetail]: "+jobDetail+"; targetBean: "+targetBean+"; targetMethod: "+targetMethod+"; arguments: "+arguments+";");
		}
		finally
		{
			logger.debug("end");
	...
	{
		private static Logger logger = LoggerFactory.getLogger(BeanInvokingJob.class);
		...
		public void execute(JobExecutionContext context) throws JobExecutionException{
			String targetBean = null,targetMethod = null;
			try
			{
				logger.debug("start");
